...
caches (`vendor/bin/typo3 cache:flush`) after changing `KeepList`, service tags or a `FrankenPhpWorker.php`.
...
classification with reasons so you can see why a service is kept or discarded and tune it: extension authors use
